                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    <p class="d-inline-block border border-white rounded text-primary fw-semi-bold py-1 px-3 animated slideInDown">
                                        Selamat Datang</p>
                                    <h1 class="display-1 mb-4 animated slideInDown">Deswita Nur Alifia
                                    </h1>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-xxl service py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Kegiatanku</p>
                <h1 class="display-5 mb-5">Selain kuliah, Saya juga memiliki hobi yang menarik!</h1>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="nav nav-pills d-flex justify-content-between w-100 h-100 me-4">
                        <button class="nav-link w-100 d-flex align-items-center text-start border p-4 mb-4 active" data-bs-toggle="pill" data-bs-target="#tab-pane-1" type="button">
                            <h5 class="m-0"><i class="fa fa-bars text-primary me-3"></i>Outfit Of The Day!</h5>
                        </button>
                        <button class="nav-link w-100 d-flex align-items-center text-start border p-4 mb-4" data-bs-toggle="pill" data-bs-target="#tab-pane-2" type="button">
                            <h5 class="m-0"><i class="fa fa-bars text-primary me-3"></i>Alifia Cookies</h5>
                        </button>
                        <button class="nav-link w-100 d-flex align-items-center text-start border p-4 mb-4" data-bs-toggle="pill" data-bs-target="#tab-pane-3" type="button">
                            <h5 class="m-0"><i class="fa fa-bars text-primary me-3"></i>#Racunshopeebyta</h5>
                        </button>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="tab-content w-100">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <h3 class="mb-4">OOTD By Tata</h3>
                                    <p class="mb-4">Penampilan adalah hal terpenting bagi saya. Penentuan outfit atau pakaian sehari-hari saya sangat menentukan mood dan aktifitas saya.</p>
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <h3 class="mb-4">Alifia Cookies</h3>
                                    <p class="mb-4">Alifia Cookies adalah kue kering yang dibuat secara rumahan. Memiliki rasa yang lezat, cocok untuk cemilan sehari-hari maupun untuk hari raya.</p>
                                    <a href="" class="btn btn-primary py-3 px-5 mt-3">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <h3 class="mb-4">Referensi Belanja #Racunshopeebyta</h3>
                                    <p class="mb-4">Belanja memang menyenangkan, oleh karena itu saya ingin berbagi pengalaman berbelanja saya kepada kalian semua.</p>
                                    <a href="" class="btn btn-primary py-3 px-5 mt-3">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
